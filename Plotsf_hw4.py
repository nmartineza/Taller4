...
#Como en mi codigo todos los valores asociados a los distintos angulos se encuentran en la misma columa es necesario hacer slicing###

#Por ejemplo, para 20
#distx20=datosvar[1*totaliteraciones/7,4] para obtener los valores del primer agulo
#disty20=datosvar[1*totaliteraciones/7,6]
#plt.figure()
#plt.title(Para20)
#plt.plot(distx20,disty20)
#plt.savefig('Para20.pdf')
